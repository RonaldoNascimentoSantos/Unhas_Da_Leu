export function Footer() {
  return (
    <section>
      <footer className="bg-pink-50 text-pink-900">
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-1 lg:col-span-1">
              <h2 className="text-2xl font-bold text-pink-500 mb-4">Unhas da Leu</h2>
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="hover:text-pink-500 transition-colors">Agendamento</a></li>
                <li><a href="#" className="hover:text-pink-500 transition-colors">Depoimentos</a></li>
              </ul>
            </div>
            ...
            <div className="col-span-1">
              ...
              <div className="flex space-x-4">
                <a href="https://www.instagram.com/unhas_da_leu/" target="_blank" rel="noopener noreferrer" className="text-pink-900 hover:text-pink-500 transition-colors">
                ...
                <a href="https://wa.me/5571986130010?text=Eu%20gostaria%20de%20saber%20mais%20sobre%20os%20servi%C3%A7os%20da%20Unhas%20da%20Leu!" target="_blank" rel="noopener noreferrer" className="text-pink-900 hover:text-pink-500 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
